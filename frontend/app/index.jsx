...
class Wishdemo extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    if (!this.state.pingStatus){
      return (<button onClick={this.sendPing.bind(this)}>发送母亲节祝福</button>)
...
ReactDOM.render(<Wishdemo />, document.getElementById('app'));
